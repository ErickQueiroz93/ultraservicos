...
@IonicPage()
@Component({
  selector: 'page-comissionados',
  templateUrl: 'comissionados.html',
})
export class ComissionadosPage {
  ...
  getAllComissionadas() {
    ...
    .then( (res) => {
      this.twdService.loadComissionadas( this.id_parceiro )
      .then(data => {
        console.log(data);
        this.obj = data;
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad ComissionadosPage');
  }
